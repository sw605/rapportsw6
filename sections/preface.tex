...
The purpose of this report is to document the development and work process \todo{is work process an expression? would prefer 'work' -MP} of the semester project performed the spring of 2016 by our group, SW605F16.
...
\todo{would empahasise multiproject. tech is not exiting. -MP}
The developed solution consists of three parts: an app\todo{An app? more? apps - Corlin}, a server and an \gls{astep} integration.
