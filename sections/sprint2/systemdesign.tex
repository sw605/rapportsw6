...
Firstly, to store additional information about the system users, and secondly to store the score for previously assessed scores between given stable routes.
