...
For example does the API providing a POST-request under the name ``PostLocationDat'', as listed in \ref{tab:sprint2-api}, which is the method to use when sending location data to the \gls{astep} core.
...
As both the \gls{astep} service and the devices have been analysis it is possible to establish a set of requirements for sprint 2.