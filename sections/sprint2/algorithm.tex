...
The criteria are practical to some extent, but the focus of the \gls{rs} system is the time and distance criteria.
...
A disadvantages of the algorithm presented here is that the distance is calculated as a euclidean distance rather than a road distance. 
