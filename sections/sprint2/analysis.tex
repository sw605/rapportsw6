...
The manifest requires to specify the API level \todo{elaborate} for three definitions: minimum, target and maximum. \todo{connect API level and SDK version}
...
\input{sections/sprint2/alarmmanager-jobschedular.tex}
