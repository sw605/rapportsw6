\section{Test} \label{section:s2test}
The purpose of the test chapter is to document the  current functionality of the implemented solution.
...
It is preferable to activate GPS location feature as little as possible, because GPS location collection is battery consuming\citep{gpsbattery}.