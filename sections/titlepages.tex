...
Our task was to develop an Android application (\acrshort{rs}) which utilizes aSTEP to suggest rideshare partners to users by storing gathered GPS data and analyzing users routes.
