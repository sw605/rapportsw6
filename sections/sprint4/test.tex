...
It can be concluded that the app works and have an actual use when both the \gls{rs} server and \gls{astep} API is functional.
It can track users location in vehicle, store their data and display data back from \gls{astep} when expected to.
