...
'User location tracking and storage', as well as 'automatic determining regular routes' are confirmed acceptable in respectively Section \ref{subsec:bgstest} and \ref{subsec:algotest}.
The latter also partially accounting for the requirement 'suggesting ride partners' the only thing missing for this requirement, is to check whether the ride suggestions are displayed correctly to the user in the app. 
