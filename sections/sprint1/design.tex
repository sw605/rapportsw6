...
% Metatext
This section contains the overall design of the app, which is based on requirements, with inspiration taken from the different commercial products and the papers read in the analysis.
