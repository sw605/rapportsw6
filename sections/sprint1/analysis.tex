...
Actual choices and influences regarding algorithm design for ridematching will be addressed in the later design phase in Section \ref{sprint1design}.
...
We believe that advancement in smartphone sensors is an opportunity that is still not used to its fullest potential.
